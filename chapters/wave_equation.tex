		...
		\begin{itemize}
			...
			\item Find the probability density for simple harmonic oscillator, $V(x)=\frac{kx^2}{2}$. Check normalization.
				\begin{flalign*}
					...
					\rho(x) &= \frac{1}{\pm \sqrt{\frac{2E-kx^2}{m}} \int_{-A}^{A} \frac{1}{ \sqrt{\frac{2E-kx^2}{m}}} ~dx}\\
					&= \frac{1}{\pm \sqrt{\frac{2E-kx^2}{m}}\sqrt{\frac{m}{2E}}\int_{-A}^{A}\frac{1}{\sqrt{1-\frac{kx^2}{2E}}}~dx}\\
					&= \frac{1}{\pm 2\sqrt{1-\frac{kx^2}{2E}}\int_{0}^{A}\frac{1}{\sqrt{1-\frac{kx^2}{2E}}}~dx}\\
				\end{flalign*}
				...
				\end{flalign*}
				Where we note that for a SHM, the turning points are at the amplitudes $\pm A$ of the oscillation and apply the familiar trigonometric substitution. We drop $\pm$ to focus on the magnitude of $dx$. 
				\begin{flalign*}
...
\exercise{1.12}{
	...
	\begin{itemize}
		...
		But in quantum mechanics, the energy of a SHM cannot be less that $\hbar\omega/2$, where $\omega = \sqrt{k/m}$ is the classical frequency. In that case what can you say about the uncertainty product?
	\end{itemize}
}
